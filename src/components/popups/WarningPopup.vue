			...
			>
				...
				<div class="flex items-center">
					...
					<p class="my-4 text-gray5 dark:text-gray3">
						Attention, you are accessing a post that has been
						<span
					...
					<div
						...
						:class="settings.isDarkMode ? `dropdownInfoOpenDark` : `dropdownInfoOpen`"
				...
				<div class="flex justify-end items-center">
					<button class="text-negative focus:outline-none mr-6" @click="emit(`close`)">View Post</button>
					<button
